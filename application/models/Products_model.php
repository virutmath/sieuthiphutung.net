...
class Products_model extends MY_Model
{
    ...
    {
        $count = $this->fields('*count*')->where('deleted_at', null)->get();
        return $count->counted_rows;
    }
    ...
    public function getAllProducts($page, $pageSize, $date_from = null, $date_to = null)
    {
        ...
        $list = $this->fields('id,name,status,image,
								active,updated_at,
								price,hot,trending,best_seller,
								feature,view')
            ->with('categories')
            ->with('originals')
            ->with('brands')
    ...
    public function updateCategory($cat_id, $id)
    {
        return $this->update(['category_id' => $cat_id], $id);
    }
    ...
    public function addProduct($data)
    {
        ...
        foreach(['active','trending','best_seller','hot','feature'] as $boolField) {
            if(isset($data[$boolField])){
                $update_data[$boolField] = $data[$boolField];
            }
        }
