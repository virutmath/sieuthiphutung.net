...
<head>
    ...
    <link href="{{asset('smart_store/web/css/style.css')}}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{asset('smart_store/web/css/menu.css')}}" rel="stylesheet" type="text/css" media="all"/>
    <script type="text/javascript" src="{{asset('smart_store/web/js/jquery-1.7.2.min.js')}}"></script>
    <script src="{{asset('smart_store/web/js/script.js')}}" type="text/javascript"></script>
    <script type="text/javascript" src="{{asset('smart_store/web/js/nav.js')}}"></script>
    <script type="text/javascript" src="{{asset('smart_store/web/js/move-top.js')}}"></script>
    <script type="text/javascript" src="{{asset('smart_store/web/js/easing.js')}}"></script>
    <script type="text/javascript" src="{{asset('smart_store/web/js/nav-hover.js')}}"></script>
...
<div class="wrap">
    <div class="header">
        <div class="header_top">
            <div class="logo">
                <a href="index.blade.php"><img src="{{asset('smart_store/web/images/logo.png')}}" alt=""/></a>
            </div>
            <div class="header_top_right">
                        ...
                        <ul class="dropdown languges">
                            <li>
                                <a href="#" title="Français">
                                    <span><img src="{{asset('smart_store/web/images/gb.png')}}" alt="en" width="26" height="26"></span><span
                                            class="lang">English</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Français">
                                    <span><img src="{{asset('smart_store/web/images/au.png')}}" alt="fr" width="26" height="26"></span><span
                                            class="lang">Français</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Español">
                                    <span><img src="{{asset('smart_store/web/images/bm.png')}}" alt="es" width="26" height="26"></span><span
                                            class="lang">Español</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Deutsch">
                                    <span><img src="{{asset('smart_store/web/images/ck.png')}}" alt="de" width="26" height="26"></span><span
                                            class="lang">Deutsch</span>
                                </a>
                            </li>
                            <li>
                                <a href="$" title="Russian">
                                    <span><img src="{{asset('smart_store/web/images/cu.png')}}" alt="ru" width="26" height="26"></span><span
                ...
                <div class="login">
                    <span><a href="login.html"><img src="{{asset('smart_store/web/images/login.png')}}" alt="" title="login"/></a></span>
                </div>
                <div class="clear"></div>
            </div>
            <div class="clear"></div>
        ...
        <div class="header_bottom">
            <div class="header_bottom_left">
                <div class="section group">
                    <div class="listview_1_of_2 images_1_of_2">
                        <div class="listimg listimg_2_of_1">
                            <a href="preview.html"> <img src="{{asset('smart_store/web/images/pic4.png')}}" alt=""/></a>
                        </div>
                    ...
                    <div class="listview_1_of_2 images_1_of_2">
                        <div class="listimg listimg_2_of_1">
                            <a href="preview-5.html"><img src="{{asset('smart_store/web/images/pic3.png')}}" alt="" /></a>
                        </div>
                        <div class="text list_2_of_1">
                            <h2>Sansung</h2>
                ...
                <div class="section group">
                    <div class="listview_1_of_2 images_1_of_2">
                        <div class="listimg listimg_2_of_1">
                            <a href="preview-3.html"> <img src="{{asset('smart_store/web/images/pic3.jpg')}}" alt=""/></a>
                        </div>
                        <div class="text list_2_of_1">
                            <h2>Acer</h2>
                    ...
                    <div class="listview_1_of_2 images_1_of_2">
                        <div class="listimg listimg_2_of_1">
                            <a href="preview-6.html"><img src="{{asset('smart_store/web/images/pic1.png')}}" alt=""/></a>
                        </div>
                        <div class="text list_2_of_1">
                            <h2>Canon</h2>
            ...
            <div class="header_bottom_right_images">
                ...
                <section class="slider">
                    <div class="flexslider">
                        <ul class="slides">
                            <li><img src="{{asset('smart_store/web/images/1.jpg')}}" alt=""/></li>
                            <li><img src="{{asset('smart_store/web/images/2.jpg')}}" alt=""/></li>
                            <li><img src="{{asset('smart_store/web/images/3.jpg')}}" alt=""/></li>
                            <li><img src="{{asset('smart_store/web/images/4.jpg')}}" alt=""/></li>
                        </ul>
                    </div>
                </section>
                <!-- FlexSlider -->
        ...
        <div class="content">
            ...
            <div class="section group">
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="preview-3.html"><img src="{{asset('smart_store/web/images/feature-pic1.png')}}" alt=""/></a>
                    ...
                    <div class="button"><span><img src="{{asset('smart_store/web/images/cart.jpg')}}" alt=""/><a href="preview-3.html"
                                                                                        class="cart-button">Add to
                                Cart</a></span></div>
                    <div class="button"><span><a href="preview-3.html" class="details">Details</a></span></div>
                </div>
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="preview-2.html"><img src="{{asset('smart_store/web/images/feature-pic2.jpg')}}" alt=""/></a>
                    ...
                    <div class="button"><span><img src="{{asset('smart_store/web/images/cart.jpg')}}" alt=""/><a href="#" class="cart-button">Add
                                to Cart</a></span></div>
                    <div class="button"><span><a href="#" class="details">Details</a></span></div>
                </div>
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="preview-4.html"><img src="{{asset('smart_store/web/images/feature-pic3.jpg')}}" alt=""/></a>
                    ...
                    <div class="button"><span><img src="{{asset('smart_store/web/images/cart.jpg')}}" alt=""/><a href="preview-6.html"
                                                                                        class="cart-button">Add to
                                Cart</a></span></div>
                    <div class="button"><span><a href="#" class="details">Details</a></span></div>
                </div>
                <div class="grid_1_of_4 images_1_of_4">
                    <img src="{{asset('smart_store/web/images/feature-pic4.png')}}" alt=""/>
            ...
            <div class="section group">
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="preview-3.html"><img src="{{asset('smart_store/web/images/new-pic1.jpg')}}" alt=""/></a>
                ...
                <div class="grid_1_of_4 images_1_of_4">
                    <a href="preview-4.html"><img src="{{asset('smart_store/web/images/new-pic2.jpg')}}" alt=""/></a>
                    ...
                    <div class="button"><span><img src="{{asset('smart_store/web/images/cart.jpg')}}" alt=""/><a href="preview-4.html"
                                                                                        class="cart-button">Add to
                                Cart</a></span></div>
                ...
                <div class="grid_1_of_4 images_1_of_4">
                    ...
                    <div class="button"><span><img src="{{asset('smart_store/web/images/cart.jpg')}}" alt=""/><a href="preview-2.html"
                                                                                        class="cart-button">Add to
                                Cart</a></span></div>
                    <div class="button"><span><a href="preview-2.html" class="details">Details</a></span></div>
                </div>
                <div class="grid_1_of_4 images_1_of_4">
                    <img src="{{asset('smart_store/web/images/new-pic3.jpg')}}" alt=""/>
        ...
        <div class="section group">
            ...
            <div class="col_1_of_4 span_1_of_4">
                ...
                <ul>
                    ...
                    <li><a href="index.blade.php">View Cart</a></li>
...
<link href="{{asset('smart_store/web/css/flexslider.css')}}" rel='stylesheet' type='text/css'/>
<script defer src="{{asset('smart_store/web/js/jquery.flexslider.js')}}"></script>
<script type="text/javascript">
