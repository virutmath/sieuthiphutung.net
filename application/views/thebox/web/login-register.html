...
<head>
    <title>the box - Login register</title>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Home</a>
                                                                <p>Pretium sociosqu scelerisque tortor tempor</p>
                                                            </li>
                                                            <li><a href="#">Kitchen</a>
                                                                <p>Sapien est cursus iaculis suspendisse</p>
                                                            </li>
                                                            <li><a href="#">Furniture & Decor</a>
                                                                <p>Libero posuere fermentum enim dictumst</p>
                                                            </li>
                                                            <li><a href="#">Bedding & Bath</a>
                                                                <p>Malesuada fames placerat semper accumsan</p>
                                                            </li>
                                                            <li><a href="#">Appilances</a>
                                                                <p>Justo imperdiet dictumst donec erat</p>
                                                            </li>
                                                            <li><a href="#">Patio, Lawn & Garden</a>
                                                                <p>Auctor odio mus ullamcorper vel</p>
                                                            </li>
                                                            <li><a href="#">Wedding Registry</a>
                                                                <p>Adipiscing aenean viverra quis pharetra</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Home Improvement</a>
                                                                <p>Class nam porttitor leo praesent</p>
                                                            </li>
                                                            <li><a href="#">Lamps & Light Fixtures</a>
                                                                <p>Eleifend malesuada per himenaeos commodo</p>
                                                            </li>
                                                            <li><a href="#">Kitchen & Bath Fixtures</a>
                                                                <p>Iaculis dolor adipiscing quis amet</p>
                                                            </li>
                                                            <li><a href="#">Home Automation</a>
                                                                <p>Id cubilia euismod primis amet</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Necklances & Pendants</a>
                                                                <p>Porta facilisis cum morbi curae</p>
                                                            </li>
                                                            <li><a href="#">Bracelets</a>
                                                                <p>Tempus mauris primis magna nulla</p>
                                                            </li>
                                                            <li><a href="#">Rings</a>
                                                                <p>Mus urna cursus nostra luctus</p>
                                                            </li>
                                                            <li><a href="#">Errings</a>
                                                                <p>Vulputate cum litora accumsan est</p>
                                                            </li>
                                                            <li><a href="#">Wedding & Engagement</a>
                                                                <p>Turpis enim iaculis nisi justo</p>
                                                            </li>
                                                            <li><a href="#">Charms</a>
                                                                <p>Nec etiam fermentum cum molestie</p>
                                                            </li>
                                                            <li><a href="#">Booches</a>
                                                                <p>Vehicula eu arcu praesent commodo</p>
                                                            </li>
                                                            <li><a href="#">Men's Jewelry</a>
                                                                <p>Sociis nunc duis vel sem</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Contemporary & Designer</a>
                                                                <p>Senectus nunc egestas mus condimentum</p>
                                                            </li>
                                                            <li><a href="#">Juniors</a>
                                                                <p>Ante cras ultrices libero at</p>
                                                            </li>
                                                            <li><a href="#">Meternity</a>
                                                                <p>Integer elementum fermentum risus enim</p>
                                                            </li>
                                                            <li><a href="#">Pettite</a>
                                                                <p>Hendrerit platea risus imperdiet odio</p>
                                                            </li>
                                                            <li><a href="#">Uniforms, Works & Safety</a>
                                                                <p>Aliquam curae aliquet tortor fames</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Accessories</a>
                                                                <p>Mattis ultricies magna viverra urna</p>
                                                            </li>
                                                            <li><a href="#">Active Wear</a>
                                                                <p>Eros est aliquam ad ridiculus</p>
                                                            </li>
                                                            <li><a href="#">Coats & Jackets</a>
                                                                <p>Nam ultricies suscipit penatibus duis</p>
                                                            </li>
                                                            <li><a href="#">Jeans</a>
                                                                <p>Nullam amet per netus non</p>
                                                            </li>
                                                            <li><a href="#">Sets</a>
                                                                <p>Phasellus vulputate massa sodales habitant</p>
                                                            </li>
                                                            <li><a href="#">Indoors</a>
                                                                <p>Himenaeos feugiat sagittis curabitur ac</p>
                                                            </li>
                                                            <li><a href="#">Swimwear</a>
                                                                <p>Tempus justo pharetra nunc mi</p>
                                                            </li>
                                                            <li><a href="#">Special Occasion</a>
                                                                <p>Donec adipiscing libero class consequat</p>
                                                            </li>
                                                            <li><a href="#">Shoes</a>
                                                                <p>Risus dignissim ut nulla aliquet</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Kids Furniture</a>
                                                                <p>Auctor torquent phasellus integer sem</p>
                                                            </li>
                                                            <li><a href="#">Kids Jewelry & Watches</a>
                                                                <p>Faucibus ridiculus velit nulla aenean</p>
                                                            </li>
                                                            <li><a href="#">Toys & Games</a>
                                                                <p>Taciti facilisis eget in justo</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">TV & Video</a>
                                                                <p>Metus suscipit elit ipsum duis</p>
                                                            </li>
                                                            <li><a href="#">Home Audio & Theater</a>
                                                                <p>Donec ut faucibus maecenas mattis</p>
                                                            </li>
                                                            <li><a href="#">Camera, Photo & Video</a>
                                                                <p>Facilisis augue ullamcorper maecenas platea</p>
                                                            </li>
                                                            <li><a href="#">Cell Phones & Accessories</a>
                                                                <p>Dignissim nisi habitant varius non</p>
                                                            </li>
                                                            <li><a href="#">Headphones</a>
                                                                <p>Convallis senectus integer sem non</p>
                                                            </li>
                                                            <li><a href="#">Video Games</a>
                                                                <p>Consequat ultrices quisque nulla venenatis</p>
                                                            </li>
                                                            <li><a href="#">Gar Electronics</a>
                                                                <p>Sociis ultricies est natoque viverra</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Laptops & Tablets</a>
                                                                <p>Etiam cras pellentesque praesent eu</p>
                                                            </li>
                                                            <li><a href="#">Desktops & Monitors</a>
                                                                <p>Fermentum leo tempus ullamcorper lacinia</p>
                                                            </li>
                                                            <li><a href="#">Computer Accessories</a>
                                                                <p>Pellentesque semper nunc mi massa</p>
                                                            </li>
                                                            <li><a href="#">Software</a>
                                                                <p>Himenaeos ipsum eleifend potenti tempor</p>
                                                            </li>
                                                            <li><a href="#">Printers & Ink</a>
                                                                <p>Pretium nunc magnis dignissim molestie</p>
                                                            </li>
                                                            <li><a href="#">Networking</a>
                                                                <p>Fermentum natoque ornare faucibus imperdiet</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="dropdown-menu-category-section-content">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Woman</a>
                                                                <p>Cursus class ad lacus viverra</p>
                                                            </li>
                                                            <li><a href="#">Men</a>
                                                                <p>Tempor cras mollis eros sociosqu</p>
                                                            </li>
                                                            <li><a href="#">Girls</a>
                                                                <p>Nulla faucibus porttitor fermentum vel</p>
                                                            </li>
                                                            <li><a href="#">Boys</a>
                                                                <p>Sociosqu mollis dapibus class potenti</p>
                                                            </li>
                                                            <li><a href="#">Baby</a>
                                                                <p>Luctus pretium mattis aliquam purus</p>
                                                            </li>
                                                            <li><a href="#">Luggage</a>
                                                                <p>Sociis dictum in aptent sociosqu</p>
                                                            </li>
                                                            <li><a href="#">Accessories</a>
                                                                <p>Nascetur tempus nunc neque odio</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Athletic Clothing</a>
                                                                <p>Class dictumst ipsum suspendisse conubia</p>
                                                            </li>
                                                            <li><a href="#">Exorcise & Fitness</a>
                                                                <p>Vehicula dapibus donec natoque nullam</p>
                                                            </li>
                                                            <li><a href="#">Hunting & Fishing</a>
                                                                <p>Dis cum mauris lectus gravida</p>
                                                            </li>
                                                            <li><a href="#">Team Sports</a>
                                                                <p>Ornare natoque consectetur vehicula diam</p>
                                                            </li>
                                                            <li><a href="#">Fan Sports</a>
                                                                <p>Sem taciti sollicitudin porttitor sodales</p>
                                                            </li>
                                                            <li><a href="#">Golf</a>
                                                                <p>Ipsum integer porta quam vitae</p>
                                                            </li>
                                                            <li><a href="#">Sports Collections</a>
                                                                <p>Leo conubia cras est fermentum</p>
                                                            </li>
                                                            <li><a href="#">Camping & Hiking</a>
                                                                <p>Litora blandit massa tempor per</p>
                                                            </li>
                                                            <li><a href="#">Cycling</a>
                                                                <p>Donec justo libero duis nec</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Video Games & Consoles</a>
                                                                <p>Egestas torquent augue scelerisque nunc</p>
                                                            </li>
                                                            <li><a href="#">Music</a>
                                                                <p>Montes potenti venenatis taciti elit</p>
                                                            </li>
                                                    ...
                                                    <div class="col-md-4">
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Backyard Poultry Supplies</a>
                                                                <p>Donec convallis ac tortor nullam</p>
                                                            </li>
                                                            <li><a href="#">Bird Supplies</a>
                                                                <p>Et bibendum molestie nisi sem</p>
                                                            </li>
                                                            <li><a href="#">Cat Supplies</a>
                                                                <p>Himenaeos sed feugiat neque sollicitudin</p>
                                                            </li>
                                                            <li><a href="#">Dog Supplies</a>
                                                                <p>Facilisis mollis vehicula vivamus consectetur</p>
                                                            </li>
                                                            <li><a href="#">Pet Memorials & Urns</a>
                                                                <p>Ligula proin proin sociosqu sagittis</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Fish & Aquariums</a>
                                                                <p>Facilisi nec nascetur quisque lobortis</p>
                                                            </li>
                                                            <li><a href="#">Horse Supplies</a>
                                                                <p>Maecenas tortor class nisl ultrices</p>
                                                            </li>
                                                            <li><a href="#">Reptile Supplies</a>
                                                                <p>Ultricies a mollis suscipit eleifend</p>
                                                            </li>
                                                            <li><a href="#">Small Animal Supplies</a>
                                                                <p>Dolor nullam quis ultricies ultrices</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Wholesale Lots</a>
                                                                <p>Porta netus nibh tellus condimentum</p>
                                                            </li>
                                                            <li><a href="#">Other Pet Supplies</a>
                                                                <p>Sociis feugiat est platea lectus</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-shipping-cart">
                                ...
                                <li>
                                    ...
                                    <div class="dropdown-menu-shipping-cart-inner">
                                        <p class="dropdown-menu-shipping-cart-price">$64</p>
