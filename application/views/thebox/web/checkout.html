                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Home</a>
                                                                <p>Nisi interdum himenaeos placerat tellus</p>
                                                            </li>
                                                            <li><a href="#">Kitchen</a>
                                                                <p>Cubilia cum curae hendrerit habitasse</p>
                                                            </li>
                                                            <li><a href="#">Furniture & Decor</a>
                                                                <p>Massa facilisi diam est facilisi</p>
                                                            </li>
                                                            <li><a href="#">Bedding & Bath</a>
                                                                <p>Amet tortor nisl suscipit torquent</p>
                                                            </li>
                                                            <li><a href="#">Appilances</a>
                                                                <p>Nunc nec aliquam scelerisque venenatis</p>
                                                            </li>
                                                            <li><a href="#">Patio, Lawn & Garden</a>
                                                                <p>Turpis cursus eleifend viverra semper</p>
                                                            </li>
                                                            <li><a href="#">Wedding Registry</a>
                                                                <p>Condimentum cursus facilisi ad dictumst</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Home Improvement</a>
                                                                <p>At volutpat proin eros tristique</p>
                                                            </li>
                                                            <li><a href="#">Lamps & Light Fixtures</a>
                                                                <p>Parturient phasellus per cubilia imperdiet</p>
                                                            </li>
                                                            <li><a href="#">Kitchen & Bath Fixtures</a>
                                                                <p>Bibendum enim quis rutrum ornare</p>
                                                            </li>
                                                            <li><a href="#">Home Automation</a>
                                                                <p>Hac dui varius non sociis</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Necklances & Pendants</a>
                                                                <p>Lorem lectus pharetra accumsan adipiscing</p>
                                                            </li>
                                                            <li><a href="#">Bracelets</a>
                                                                <p>Imperdiet at purus semper himenaeos</p>
                                                            </li>
                                                            <li><a href="#">Rings</a>
                                                                <p>Malesuada iaculis fermentum maecenas dolor</p>
                                                            </li>
                                                            <li><a href="#">Errings</a>
                                                                <p>Purus mauris fermentum tempus dolor</p>
                                                            </li>
                                                            <li><a href="#">Wedding & Engagement</a>
                                                                <p>Tellus vivamus rhoncus neque fusce</p>
                                                            </li>
                                                            <li><a href="#">Charms</a>
                                                                <p>Amet natoque elementum integer nulla</p>
                                                            </li>
                                                            <li><a href="#">Booches</a>
                                                                <p>Mattis ac aenean facilisi faucibus</p>
                                                            </li>
                                                            <li><a href="#">Men's Jewelry</a>
                                                                <p>Eleifend placerat cursus dictumst rhoncus</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Contemporary & Designer</a>
                                                                <p>Fusce semper suspendisse varius ligula</p>
                                                            </li>
                                                            <li><a href="#">Juniors</a>
                                                                <p>Habitasse montes non accumsan hendrerit</p>
                                                            </li>
                                                            <li><a href="#">Meternity</a>
                                                                <p>Velit congue lobortis varius feugiat</p>
                                                            </li>
                                                            <li><a href="#">Pettite</a>
                                                                <p>Euismod scelerisque phasellus hendrerit magna</p>
                                                            </li>
                                                            <li><a href="#">Uniforms, Works & Safety</a>
                                                                <p>Lorem phasellus facilisi mus ligula</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Accessories</a>
                                                                <p>Metus sit sociis egestas felis</p>
                                                            </li>
                                                            <li><a href="#">Active Wear</a>
                                                                <p>Dictumst curae proin orci class</p>
                                                            </li>
                                                            <li><a href="#">Coats & Jackets</a>
                                                                <p>Tempus litora nisi quisque sollicitudin</p>
                                                            </li>
                                                            <li><a href="#">Jeans</a>
                                                                <p>Iaculis risus ullamcorper inceptos vehicula</p>
                                                            </li>
                                                            <li><a href="#">Sets</a>
                                                                <p>Etiam rhoncus himenaeos cras platea</p>
                                                            </li>
                                                            <li><a href="#">Indoors</a>
                                                                <p>Aliquet consequat justo congue vehicula</p>
                                                            </li>
                                                            <li><a href="#">Swimwear</a>
                                                                <p>Luctus quisque convallis duis sed</p>
                                                            </li>
                                                            <li><a href="#">Special Occasion</a>
                                                                <p>Odio sodales arcu ultricies ac</p>
                                                            </li>
                                                            <li><a href="#">Shoes</a>
                                                                <p>Sociosqu dolor dis gravida duis</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Kids Furniture</a>
                                                                <p>Suscipit ligula nostra natoque pulvinar</p>
                                                            </li>
                                                            <li><a href="#">Kids Jewelry & Watches</a>
                                                                <p>Aptent facilisi vulputate augue sit</p>
                                                            </li>
                                                            <li><a href="#">Toys & Games</a>
                                                                <p>Gravida augue neque consequat elementum</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">TV & Video</a>
                                                                <p>Ultrices luctus rutrum varius congue</p>
                                                            </li>
                                                            <li><a href="#">Home Audio & Theater</a>
                                                                <p>Luctus cum ultricies pulvinar sem</p>
                                                            </li>
                                                            <li><a href="#">Camera, Photo & Video</a>
                                                                <p>Auctor curabitur ipsum dictumst tincidunt</p>
                                                            </li>
                                                            <li><a href="#">Cell Phones & Accessories</a>
                                                                <p>Commodo dui senectus leo proin</p>
                                                            </li>
                                                            <li><a href="#">Headphones</a>
                                                                <p>Pulvinar lectus blandit metus bibendum</p>
                                                            </li>
                                                            <li><a href="#">Video Games</a>
                                                                <p>Eros pellentesque lacus sociosqu ac</p>
                                                            </li>
                                                            <li><a href="#">Gar Electronics</a>
                                                                <p>Malesuada urna condimentum tempus ligula</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Laptops & Tablets</a>
                                                                <p>Vulputate litora nulla tellus blandit</p>
                                                            </li>
                                                            <li><a href="#">Desktops & Monitors</a>
                                                                <p>Ad laoreet netus diam hac</p>
                                                            </li>
                                                            <li><a href="#">Computer Accessories</a>
                                                                <p>Amet vel proin neque penatibus</p>
                                                            </li>
                                                            <li><a href="#">Software</a>
                                                                <p>Sem pretium eu ad magnis</p>
                                                            </li>
                                                            <li><a href="#">Printers & Ink</a>
                                                                <p>Nulla morbi fermentum taciti in</p>
                                                            </li>
                                                            <li><a href="#">Networking</a>
                                                                <p>Vitae facilisis enim malesuada pellentesque</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="dropdown-menu-category-section-content">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Woman</a>
                                                                <p>Cursus massa ultricies dignissim odio</p>
                                                            </li>
                                                            <li><a href="#">Men</a>
                                                                <p>Vestibulum conubia per ut maecenas</p>
                                                            </li>
                                                            <li><a href="#">Girls</a>
                                                                <p>Auctor placerat risus in elementum</p>
                                                            </li>
                                                            <li><a href="#">Boys</a>
                                                                <p>Feugiat id montes nibh dis</p>
                                                            </li>
                                                            <li><a href="#">Baby</a>
                                                                <p>Lobortis eu nisi imperdiet eros</p>
                                                            </li>
                                                            <li><a href="#">Luggage</a>
                                                                <p>Leo egestas maecenas lobortis id</p>
                                                            </li>
                                                            <li><a href="#">Accessories</a>
                                                                <p>Vehicula nibh fermentum urna primis</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Athletic Clothing</a>
                                                                <p>Facilisis metus lectus aliquet porta</p>
                                                            </li>
                                                            <li><a href="#">Exorcise & Fitness</a>
                                                                <p>Fames quam sodales id imperdiet</p>
                                                            </li>
                                                            <li><a href="#">Hunting & Fishing</a>
                                                                <p>Donec nulla leo vitae pellentesque</p>
                                                            </li>
                                                            <li><a href="#">Team Sports</a>
                                                                <p>Fringilla magna scelerisque lectus leo</p>
                                                            </li>
                                                            <li><a href="#">Fan Sports</a>
                                                                <p>Nisi auctor integer ut himenaeos</p>
                                                            </li>
                                                            <li><a href="#">Golf</a>
                                                                <p>Mauris tempus est tortor habitant</p>
                                                            </li>
                                                            <li><a href="#">Sports Collections</a>
                                                                <p>Primis integer risus euismod eu</p>
                                                            </li>
                                                            <li><a href="#">Camping & Hiking</a>
                                                                <p>Sit commodo mus in magnis</p>
                                                            </li>
                                                            <li><a href="#">Cycling</a>
                                                                <p>Ligula taciti inceptos tempor vehicula</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Video Games & Consoles</a>
                                                                <p>Lectus cum vehicula curae a</p>
                                                            </li>
                                                            <li><a href="#">Music</a>
                                                                <p>Vitae diam dignissim quis proin</p>
                                                            </li>
                                                            <li><a href="#">DVD & Movies</a>
                                                                <p>Metus nunc laoreet quisque ligula</p>
                                                            </li>
                                                            <li><a href="#">Tickets</a>
                                                                <p>Neque erat tristique velit nunc</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                            ...
                                            <div class="dropdown-menu-category-section-content">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Luggage</a>
                                                                <p>Urna massa magna tempor phasellus</p>
                                                            </li>
                                                            <li><a href="#">Travel Accessories</a>
                                                                <p>Ipsum ad tristique egestas vestibulum</p>
                                                            </li>
                                                            <li><a href="#">Luggage Accessories</a>
                                                                <p>Accumsan semper rutrum ac lectus</p>
                                                            </li>
                                                            <li><a href="#">Lodging</a>
                                                                <p>Dolor augue tincidunt ridiculus curabitur</p>
                                                            </li>
                                                            <li><a href="#">Maps</a>
                                                                <p>Fermentum laoreet vivamus est eleifend</p>
                                                            </li>
                                                            <li><a href="#">Other Travel</a>
                                                                <p>Accumsan mi orci aliquam ligula</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Vacation Packages</a>
                                                                <p>Imperdiet suspendisse leo condimentum aenean</p>
                                                            </li>
                                                            <li><a href="#">Campground & RV</a>
                                                                <p>Adipiscing phasellus sed ipsum primis</p>
                                                            </li>
                                                            <li><a href="#">Rail</a>
                                                                <p>Ligula turpis ad arcu a</p>
                                                            </li>
                                                            <li><a href="#">Car Rental</a>
                                                                <p>Elit sed nostra aenean dapibus</p>
                                                            </li>
                                                            <li><a href="#">Cruises</a>
                                                                <p>Enim magna quis mauris felis</p>
                                                            </li>
                                                            <li><a href="#">Airline</a>
                                                                <p>Etiam tristique orci lorem auctor</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Paintings from Dealers & Resellers</a>
                                                                <p>Platea id platea litora sociis</p>
                                                            </li>
                                                            <li><a href="#">Paintings Direct from Artist</a>
                                                                <p>Augue lectus morbi mus nec</p>
                                                            </li>
                                                            <li><a href="#">Art Prints</a>
                                                                <p>Placerat ultricies nascetur egestas tortor</p>
                                                            </li>
                                                            <li><a href="#">Art Photographs from Resellers</a>
                                                                <p>Phasellus class suspendisse amet interdum</p>
                                                            </li>
                                                            <li><a href="#">Art Photographs from the Artist</a>
                                                                <p>Suscipit sit nisi donec at</p>
                                                            </li>
                                                            <li><a href="#">Art Posters</a>
                                                                <p>Vitae metus penatibus libero orci</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Home Decor Decals</a>
                                                                <p>Facilisi tempus duis phasellus tellus</p>
                                                            </li>
                                                            <li><a href="#">Furniture</a>
                                                                <p>Leo commodo lacinia primis libero</p>
                                                            </li>
                                                            <li><a href="#">Wallpapers</a>
                                                                <p>Facilisis praesent sociis malesuada morbi</p>
                                                            </li>
                                                            <li><a href="#">Bar Flasks</a>
                                                                <p>Ullamcorper parturient pharetra at sodales</p>
                                                            </li>
                                                            <li><a href="#">Posters & Prints</a>
                                                                <p>Cursus nec nam suspendisse sit</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Parts & Accessories</a>
                                                                <p>Facilisi erat sed non lacinia</p>
                                                            </li>
                                                            <li><a href="#">Cars & Trucks</a>
                                                                <p>Tellus adipiscing viverra arcu nullam</p>
                                                            </li>
                                                            <li><a href="#">Motorcycles</a>
                                                                <p>Habitasse ultricies scelerisque elementum cubilia</p>
                                                            </li>
                                                            <li><a href="#">Passenger Vehicles</a>
                                                                <p>Torquent primis ultricies elementum suscipit</p>
                                                            </li>
                                                            <li><a href="#">Industry Vehicles</a>
                                                                <p>Leo interdum vivamus euismod amet</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-4">
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Backyard Poultry Supplies</a>
                                                                <p>Feugiat felis duis tellus et</p>
                                                            </li>
                                                            <li><a href="#">Bird Supplies</a>
                                                                <p>Mattis enim erat cras vitae</p>
                                                            </li>
                                                            <li><a href="#">Cat Supplies</a>
                                                                <p>Tempor cubilia cubilia mus at</p>
                                                            </li>
                                                            <li><a href="#">Dog Supplies</a>
                                                                <p>Conubia a nisi eu fames</p>
                                                            </li>
                                                            <li><a href="#">Pet Memorials & Urns</a>
                                                                <p>Varius varius magnis et pharetra</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Fish & Aquariums</a>
                                                                <p>Urna dictum consequat lacinia interdum</p>
                                                            </li>
                                                            <li><a href="#">Horse Supplies</a>
                                                                <p>Facilisi leo tristique pretium felis</p>
                                                            </li>
                                                            <li><a href="#">Reptile Supplies</a>
                                                                <p>Fusce fringilla praesent dui imperdiet</p>
                                                            </li>
                                                            <li><a href="#">Small Animal Supplies</a>
                                                                <p>Lacus primis leo porta justo</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Wholesale Lots</a>
                                                                <p>Non vulputate suspendisse ad porta</p>
                                                            </li>
                                                            <li><a href="#">Other Pet Supplies</a>
                                                                <p>Fermentum velit lectus sociis in</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <ul class="dropdown-menu-category-list">
                                                            <li><a href="#">Model & Kit Tools</a>
                                                                <p>Turpis donec curabitur consectetur cras</p>
                                                            </li>
                                                            <li><a href="#">Supplies & Engines</a>
                                                                <p>Et ultricies quis felis accumsan</p>
                                                            </li>
                                                            <li><a href="#">RC Airline & Helicopter</a>
                                                                <p>Natoque nam dapibus risus mus</p>
                                                            </li>
                                                            <li><a href="#">RC Car, Truck & motorcycle</a>
                                                                <p>Nulla turpis integer suscipit mi</p>
                                                            </li>
                                                            <li><a href="#">Military Airline Models & Kits</a>
                                                                <p>Enim elementum urna id lacinia</p>
                                                            </li>
                                                            <li><a href="#">Craft Airbrushing Supplies</a>
                                                                <p>Convallis quam rhoncus cubilia justo</p>
                                                            </li>
                                                            <li><a href="#">Card Making Supplies</a>
                                                                <p>Sapien sagittis nullam vehicula adipiscing</p>
                                                            </li>
                                                            <li><a href="#">Craft Sewing</a>
                                                                <p>Aliquam netus aptent tristique nisi</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                            ...
                            <ul class="dropdown-menu dropdown-menu-shipping-cart">
                                <li>
                                    ...
                                    <div class="dropdown-menu-shipping-cart-inner">
                                        <p class="dropdown-menu-shipping-cart-price">$63</p>
                                ...
                                <li>
                                    ...
                                    <div class="dropdown-menu-shipping-cart-inner">
                                        <p class="dropdown-menu-shipping-cart-price">$55</p>
                                ...
                                <li>
                                    ...
                                    <div class="dropdown-menu-shipping-cart-inner">
                                        <p class="dropdown-menu-shipping-cart-price">$78</p>
            ...
            <div class="container">
                <div class="row row-col-gap" data-gutter="60">
                    <div class="col-md-3">
                        ...
                        <p>Enim nibh integer auctor fusce tristique a mus arcu sit pellentesque nunc</p>
